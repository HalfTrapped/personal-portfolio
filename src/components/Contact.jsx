...
const Contact = () => {
  return (
    <div id='Contact' className='flex flex-col min-h-screen w-full items-center justify-center gap-16 p-8 '>
      <h1 className='text-center text-6xl font-light text-teal-600 '>Get in Touch</h1>
      <form className='flex w-full max-w-md flex-col gap-8 rounded-lg o-6 md:max-w-lg lg:max-w-xl '>
