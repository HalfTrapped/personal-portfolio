...
import { BiBriefcase, BiRightArrowAlt } from 'react-icons/bi'
...
const HeaderLeft = () => {
  return (
    <div className ='md:flex-[1] '>
      ...
      <div className="hidden md:flex fixed left-0 top-0 h-screen w-1/4 bg-teal-600 text-white items-center justify-center">
      ...
      <div className='fixed left-o right-0 top-0 z-10 flex justify-evenly bg-teal-600 p-5 text-white md:hidden'>
